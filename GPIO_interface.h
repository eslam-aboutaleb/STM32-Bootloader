...
/*Disable clock in RCC register*/
#define RCC_GPIOA_CLK_DISABLE()       (RCC->AHB1RSTR |= (1<<0))
#define RCC_GPIOB_CLK_DISABLE()       (RCC->AHB1RSTR |= (1<<1))
#define RCC_GPIOC_CLK_DISABLE()       (RCC->AHB1RSTR |= (1<<2))
#define RCC_GPIOD_CLK_DISABLE()       (RCC->AHB1RSTR |= (1<<3))
#define RCC_GPIOE_CLK_DISABLE()       (RCC->AHB1RSTR |= (1<<4))
