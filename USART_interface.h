...
#define UART_GET_FLAG(__HANDLE__, __FLAG__) (((__HANDLE__)->Instance->SR & (__FLAG__)) == (__FLAG__))   
...
/*Macros to enable the clocks for various UART */
#define RCC_USART1_CLK_DISABLE()           ( RCC->APB2RSTR |=  ( 1 << 4))
#define RCC_USART2_CLK_DISABLE()           ( RCC->APB1RSTR |=  ( 1 << 17))
#define RCC_USART3_CLK_DISABLE()           ( RCC->APB1RSTR |=  ( 1 << 18))
#define RCC_UART4_CLK_DISABLE()            ( RCC->APB1RSTR |=  ( 1 << 19))
#define RCC_UART5_CLK_DISABLE()            ( RCC->APB1RSTR |=  ( 1 << 20))
#define RCC_USART6_CLK_DISABLE()           ( RCC->APB2RSTR |=  ( 1 << 5))
...
#define USART_SR_RXNE_Msk                         (0x1U << 5)
